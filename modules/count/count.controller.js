...
const {Project,Tender,Dpr,Expense,CompanyMaterial,MaterialTransaction,Vehicle,FuelLog,Machinery,MachineryFuelLog,MachineryMaintenance,VehicleMaintenance,PermanentStockTransaction,Sequelize} =require("../../models");
...
exports.getMaterialCount = async (req, res) => {
  try {
    ...
    const totalConsumableTransaction = await MaterialTransaction.count();
    const totalPermanentTransaction = await PermanentStockTransaction.count();
    successResponse(
        res, 
        "Data retrieved successfully",
        {
            data: {
              ...
              totalTransaction:totalConsumableTransaction + totalPermanentTransaction,
            }
        ,}
    );
  } catch (error) {
...
exports.getFuelAndVehicalCount = async (req, res) => {
  try {
    ...
    const totalMaintenance = await VehicleMaintenance.sum("cost");
    successResponse(
        res, 
        "Data retrieved successfully",
        {
