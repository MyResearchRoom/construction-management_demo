...
exports.getMachineFuelLogByMchineId = async (req,res) =>{
  try {
    ...
    if(machineId){
      whereCondition.machineId=machineId;
    }
    ...
    const machineryFuelData = await MachineryFuelLog.findAll({
      where: whereCondition,
      attributes: {
        exclude: ["billPhoto"],
      },
    ...
    return successResponse(res, "Fuel entry fetch successfully",machineryFuelData);
